...
<p align="center">
  <strong>LLM Infrastructure · Low-level Performance Optimization · Systems Engineering</strong>
</p>
...
I'm building around LLM infrastructure, inference systems, and low-level performance work.

- Focused on: `LLM Infrastructure`, `Inference Optimization`, `CUDA/Systems`, `Distributed Serving`
- Interested in: runtime efficiency, model serving, memory layout, kernels, observability, and developer tooling
- Working toward: building reliable, fast, and understandable infrastructure for modern AI workloads
- Goal: keep learning in public and turn hard system details into practical engineering wins

### Tech Stack

<p>
  <img src="https://skillicons.dev/icons?i=python,cpp,rust,go,linux,docker,kubernetes,pytorch,git,github,vscode" alt="Tech stack icons" />
</p>
...
I'm open to collaboration around LLM systems, inference performance, infrastructure tooling, and practical open-source engineering.

<p align="center">
  <strong>Thanks for visiting. Let's make AI systems faster, simpler, and more reliable.</strong>
</p>
